...
internal enum Asset {
  ...
  internal enum Images {
    ...
    internal enum Home {
      ...
      internal static let buttonBackground = ImageAsset(name: "button_background")
      internal static let homeHalalLogo = ImageAsset(name: "home_halal_logo")
      internal static let lunchBox = ImageAsset(name: "lunch_box")
      internal static let metaverse = ImageAsset(name: "metaverse")
      internal static let miceTour = ImageAsset(name: "mice_tour")
      internal static let prayerTime = ImageAsset(name: "prayer_time")
      internal static let store = ImageAsset(name: "store")
      internal static let welcome = ImageAsset(name: "welcome")
    }
    internal enum Logos {
      internal static let greenHalalLogo = ImageAsset(name: "green_halal_logo")
    ...
    internal enum Icon {
      ...
      internal static let iconPrayerTime = ImageAsset(name: "icon_prayer_time")
      internal static let iconStore = ImageAsset(name: "icon_store")
      internal static let iconWhiteRoundSquare1 = ImageAsset(name: "icon_white_round_square1")
    }
  }
}
